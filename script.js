const siteData = {
  events: [
    ...
    { id: 'e2', name: 'Angkor Sound Concert', category: 'Concert', location: 'Siem Reap', date: '2026-08-12', time: '20:00', price: 55, rating: 4.9, attendees: 2200, details: 'A premium outdoor concert featuring Cambodia’s top artists and a cinematic light show near Angkor Wat.', organizer: 'Temple Nights', banner: 'https://images.unsplash.com/photo-1599930113854-d617d0c6171e?w=1200&q=80', gallery: ['https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&q=80', 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&q=80', 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&q=80'], tags: ['Concert', 'Luxury', 'Music'] },
      ...
      <article class="event-card">
        ...
        <div class="card-body">
          ...
          <div class="card-actions">
            ...
            <span class="event-badge">$${event.price}</span>
          </div>
        </div>
      </article>
    `).join('');
...
function renderEventDetails() {
  ...
  details.textContent = `Ticket price: $${event.price}. Category: ${event.category}. This premium experience is tailored for travelers seeking authentic Cambodian discovery.`;
